...
Future<void> _createTables(Database db) async {
  ...
  Future<void> _insertSampleData(Database db) async {
    ...
    int heartsFolderId =
        folderResult.firstWhere(
          (folder) => folder['folder_name'] == 'Hearts',
        )['id'];
    int spadesFolderId =
        folderResult.firstWhere(
          (folder) => folder['folder_name'] == 'Spades',
        )['id'];
    int diamondsFolderId =
        folderResult.firstWhere(
          (folder) => folder['folder_name'] == 'Diamonds',
        )['id'];
    int clubsFolderId =
        folderResult.firstWhere(
          (folder) => folder['folder_name'] == 'Clubs',
        )['id'];
  ...
  Future<void> updateCard(
    ...
    await db.update('Cards', updatedCard, where: 'id = ?', whereArgs: [id]);
  }
